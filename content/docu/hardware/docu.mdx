...
1. Mit dem AlgeaCare-WLAN verbinden
2. SMB-Client verbinden, sodass auf das File-System zugegriffen werden kann
3. Das `docu` Repository lokal öffnen
4. `deploy.sh` Skript ausführen - dieses builded die Dokumentation und kopiert die gesamten Inhalte auf den Raspberry Pi, in den `/home/pi/algeacare/docu` Ordner.
